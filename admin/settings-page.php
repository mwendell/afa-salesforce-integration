...
function afa_salesforce_sandbox_url_callback() {
	$value = get_option( 'afa_salesforce_sandbox_url', 'https://airforceassociation--fullsb.sandbox.my.salesforce.com' );
	?>
	<input type="text" name="afa_salesforce_sandbox_url" value="<?php echo esc_attr( $value ); ?>" class="regular-text" />
	<p class="description"><?php _e( 'Your Salesforce sandbox URL (e.g., https://airforceassociation--fullsb.sandbox.my.salesforce.com)', 'afa-salesforce' ); ?></p>
	<?php
}

function afa_salesforce_instance_url_callback() {
	$value = get_option( 'afa_salesforce_instance_url', 'https://airforceassociation.my.salesforce.com' );
	?>
	<input type="text" name="afa_salesforce_instance_url" value="<?php echo esc_attr( $value ); ?>" class="regular-text" />
	<p class="description"><?php _e( 'Your Salesforce production instance URL (e.g., https://airforceassociation.my.salesforce.com)', 'afa-salesforce' ); ?></p>
	<?php
}
